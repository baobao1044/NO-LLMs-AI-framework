...
```bash
python3 tools/regress.py --golden-set configs/golden_set.json --baseline configs/regression_baseline.json --write-baseline
python3 tools/regress.py --golden-set configs/golden_set.json --baseline configs/regression_baseline.json
python3 tools/regress.py --golden-set configs/ts_golden_set.json --baseline configs/ts_regression_baseline.json --write-baseline
python3 tools/regress.py --golden-set configs/ts_golden_set.json --baseline configs/ts_regression_baseline.json
```

Baseline is only updated when `--write-baseline` is explicitly passed.
